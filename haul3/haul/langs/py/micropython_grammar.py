...
This file is semi-autogenerated, it is based on an
automatic expansion ("expand_macros.py") of the Micropython grammar.

2024-04-07 Bernhard "HotKey" Slawik
"""

if __name__ == 'haul.langs.py.micropython_grammar':
